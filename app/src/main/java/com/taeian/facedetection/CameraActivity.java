...
import com.taeian.facedetection.env.ImageUtils;
import com.taeian.facedetection.env.Logger;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        found=findViewById(R.id.button11);
        ...
        found.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(CameraActivity.this,FoundActivity.class);
                startActivity(i);
            }
        });
